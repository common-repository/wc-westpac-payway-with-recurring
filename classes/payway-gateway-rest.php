...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	class WC_Payway_Gateway_Rest_Recurring extends WC_Payment_Gateway
	{
		...
		public $id = 'paywaynetrecurring';

		public $method_title =  'PayWay NET with Recurring';

		public $method_description = 'PayWay NET with Recurring';
		...
		public $automatic_email_receipts;
